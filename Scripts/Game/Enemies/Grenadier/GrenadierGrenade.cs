...
namespace Gamekit3D
{
    public class GrenadierGrenade : Projectile
    {
        ...
        public AkEvent grenadier_ranged_explotion;
        public AkEvent grenadier_ranged_bounce;
        ...
        {
            if (grenadier_ranged_explotion != null)
            {

                grenadier_ranged_explotion.HandleEvent(gameObject);
            }
        ...
        {
            if (grenadier_ranged_bounce != null)
                grenadier_ranged_bounce.HandleEvent(gameObject);
        }
